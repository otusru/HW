...
MODULE_PARM_DESC(idx, "Index in string buffer");
...
MODULE_PARM_DESC(ch_val, "ASCII character to insert");

// Только чтение str_buf
...
MODULE_PARM_DESC(str_buf, "String buffer (read-only)");
